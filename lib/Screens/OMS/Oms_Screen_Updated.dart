...
class _Oms_Screen_UpdatedState extends State<Oms_Screen_Updated> {
  ...
  /* getName(String description) {
    if (description == 'DOOR_OPEN') {
      ...
      return 'LOW SOLAR';
    } else if (description == 'FILTER_CHOKED') {
      return 'FILTER CHOKED';
    } else if (description == 'PT_FAIL') {
      return 'PT FAIL';
    } else if (description == 'POSITION_FAIL') {
      return 'POSITION FAIL';
    } else if (description == 'HIGH_TEMP') {
      return 'HIGH TEMPERATURE';
    } else if (description == 'MOTION_DETECT') {
                              ...
                              Center(
                                child: Image(
                                  image: AssetImage(getBattreydata(
                                      getBatpercentage(
                                          _DisplayList![index].batteryType !=
                                                  null
                                              ? _DisplayList![index].batteryType
                                              : 0,
