...
class Group78aItemWidget extends StatelessWidget {
  ProjectOverviewModel? model;
  Group78aItemWidget(ProjectOverviewModel? data) {
    model = data;
  }
